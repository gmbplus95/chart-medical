        ...
        <Header/>
            <section className='text-left px-[20px] pt-[20px]'>
                ...
                <div className='py-[20px] leading-[28px] font-[32px]'>
                    ...
                    <p>The Can Khon app stores and processes personal data that you have provided to us, to provide my Service. It’s your responsibility to keep your phone and access to the app secure. We, therefore, recommend that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/viruses/malicious programs, compromise your phone’s security features and it could mean that the Can Khon app won’t work properly or at all.
                    </p>
                    <p>The app does use third-party services that declare its Terms and Conditions.
                    </p>
                    <br/>
                    <p>Link to Terms and Conditions of third-party service providers used by the app
                    </p>
                    <ul className='pl-[20px] list-disc'>
                        <li>
                            <a href="https://policies.google.com/terms" className='text-[#009c9c]'>Google Play Services</a>
                        </li>
                    </ul>
                    <br/>
                    <p>
            ...
            <section className='text-left px-[20px] py-[20px]'>
                ...
                <div className='py-[20px] leading-[28px] font-[32px]'>
                    <p>
                        If you have any questions or suggestions about my Terms and Conditions, do not hesitate to contact me at hainh.nuce@gmail.com.
                    </p>
                    <br/>
                    <p>
                        This Terms and Conditions page was generated by <a href='https://app-privacy-policy-generator.nisrulz.com/' className='text-[#009c9c] underline'>App Privacy Policy Generator</a>
                    </p>
                </div>
            </section>
        <Footer />
